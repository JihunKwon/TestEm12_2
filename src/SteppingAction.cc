...
SteppingAction::SteppingAction(EventAction* event, DetectorConstruction* det, RunAction* RuAct)
...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
 ...
 //Fill Shells
 G4int ShellNb = fDetector->GetNbOfLayersB();
 if (ShellNb > 0)
 {
	 fRunAction->SaveRadialEdep(r,edep,ShellNb);
 }
